...
function submit()
{
    ...
    console.log(display_guests_array);
    document.getElementById("display_name_with_commas").innerHTML = display_guests_array;
...
function new_update()
{
    document.getElementById("display_name_without_commas").innerHTML = "<h1>" + name_of_the_guests_array +"</h1>";
}
